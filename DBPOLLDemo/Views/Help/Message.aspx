...
<div id="navwrapper">
	...
	<div id="contentwrapper">
		<div id="content">
		<a name="top"></a>
		<h2>Message Help</h2><hr />
		<p> In this section the user can send a message to anoter user as well as view <b>
            inbox</b> , <b>public messages</b> and <b>send messages</b><p> - Sending a message 
                to another user : click on <b>send a message to another user </b>, in next page 
                write the message and choose the user to send a private message&nbsp; (or select <b>Public Messages </b>to send a public message ) and click on <b>save 
                changes. </b> <p>
		
    <img src="../../Content/Message.jpg" width="800" />
