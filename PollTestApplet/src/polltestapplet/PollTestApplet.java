 ...
 * @author s4200943
 */
public class PollTestApplet extends javax.swing.JApplet {
    ...
    /** Initializes the applet PollTestApplet */
    @Override
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PollTestApplet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        public void addDeviceID(String deviceID, int key) {
            ...
            for (int row = 0; row <= this.getRowCount(); row++) {
                for (int column = 0; column < 4; column++) {
                    System.out.println("Val at: "+this.getValueAt(row, column));
                    if (this.getValueAt(row, column) == null) {
                        ...
                        System.out.println("Break22 at: " + column + " " + row);
                        this.setValueAt(deviceID + " : " + key, row, column);
                        return;
                    }
                }
